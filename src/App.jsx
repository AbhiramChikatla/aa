                    ...
                    <div className="carousel-inner smallimg">
                        <div className="carousel-item active">
                            ...
                            <div className="carousel-caption d-md-block black">
                                ...
                                >
                                    Bringing you the freshest dairy
                                    products,sourced from local farms.
                                </p>
                            </div>
                        </div>
                        <div className="carousel-item">
                            ...
                            <div className="carousel-caption   d-md-block">
                                ...
                                >
                                    ...
                                    vendors to bring you the finest dairy
                                    products.
                                </p>
                            </div>
                        </div>
                        <div className="carousel-item">
                            ...
                            <div className="carousel-caption d-md-block">
                                ...
                                >
                                    ...
                                    freshness and ensure top quality from farm
                                    to table.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-md-7">
                                <div className="testimonialcont text-center">
                                    ...
                                    >
                                        The Milk on the Way limited was founded
                                        by group of Btech students in the year
                                        2024, which is one of the fastest
                                        growing Public Listed Companies in
                                        India, with business division - Dairy.{" "}
                                    </p>
                                </div>
